...
class GameOverSubstate extends MusicBeatSubstate
{
	...
	public override function create()
	{
		...
		FlxG.camera.shake(0.25, 0.01, null, true);
		FlxTween.tween(FlxG.camera, {zoom: 1.1, angle: -1.6}, 1.5, {ease: FlxEase.quadInOut});
		add(character);
	...
	function endBullshit():Void
	{
		...
		FlxG.camera.shake(0.25, 0.01, null, true);
		FlxTween.tween(FlxG.camera, {zoom: 0.8, angle: 0}, 0.5, {ease: FlxEase.cubeOut});
