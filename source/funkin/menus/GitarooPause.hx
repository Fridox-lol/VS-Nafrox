...
class GitarooPause extends MusicBeatState
{
	...
	override function create()
	{
		if (FlxG.sound.music != null)
			...
			FlxG.sound.playMusic(Paths.music('gitarooAmbience'), 0.7);
		...
		stat.frames = Paths.getFrames('menus/nafroxmenu/story/scaryredstatic');
		stat.animation.addByPrefix('idle', 'scaryredstatic' , 24);
